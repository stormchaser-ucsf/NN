...
num_days=10
delta_recon_imag_var_days = np.zeros([224,num_days])
beta_recon_imag_var_days = np.zeros([224,num_days])
hg_recon_imag_var_days = np.zeros([224,num_days])
delta_recon_online_var_days = np.zeros([224,num_days])
beta_recon_online_var_days = np.zeros([224,num_days])
hg_recon_online_var_days = np.zeros([224,num_days])
delta_recon_batch_var_days = np.zeros([224,num_days])
beta_recon_batch_var_days = np.zeros([224,num_days])
hg_recon_batch_var_days = np.zeros([224,num_days])
...
for days in (np.arange(num_days)+1):
    ...
    delta_recon_imag_var_days[:,days-1] = delta_variances_imag
    beta_recon_imag_var_days[:,days-1] = beta_variances_imag
    hg_recon_imag_var_days[:,days-1] = hg_variances_imag
    delta_recon_online_var_days[:,days-1] = delta_variances_online
    beta_recon_online_var_days[:,days-1] = beta_variances_online
    hg_recon_online_var_days[:,days-1] = hg_variances_online
    delta_recon_batch_var_days[:,days-1] = delta_variances_batch
    beta_recon_batch_var_days[:,days-1] = beta_variances_batch
    hg_recon_batch_var_days[:,days-1] = hg_variances_batch
